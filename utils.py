...
attack_map = {1: ("dos_attacks", ["apache2","back","land","neptune","mailbomb","pod","processtable","smurf","teardrop","udpstorm","worm"]), 2: ("probe_attacks", ["ipsweep","mscan","nmap","portsweep","saint","satan"]), 3: ("privilege_attacks", ["buffer_overflow","loadmodule","perl","ps","rootkit","sqlattack","xterm"]), 4: ("access_attacks", ["ftp_write","guess_passwd","http_tunnel","imap","multihop","named","phf","sendmail","snmpgetattack","snmpguess","spy","warezclient","warezmaster","xclock","xsnoop"])}
